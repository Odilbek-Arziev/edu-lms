...
function CategoryDelete({onCancel, onSuccess, id, t}: DeleteProps) {
    ...
    async function onDelete() {
        await handleRequest(
            () => dispatch(categoriesThunk.delete(id)),
            {onSuccess}
        )
    }
        ...
        <div>
            <div className="mt-2 text-center">
                ...
                <p className="fw-bold fs-5">
                     {t('delete_confirm', {item: t('category_to_delete')})}
                </p>
            </div>
...
export default withTranslation()(CategoryDelete);