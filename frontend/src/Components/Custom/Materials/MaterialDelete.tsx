...
function MaterialDelete({onCancel, onSuccess, id, t}: DeleteProps) {
    ...
    async function onDelete() {
        await handleRequest(
            () => dispatch(materialsThunk.delete(id)),
            {onSuccess}
        )
    }
        ...
        <div>
            <div className="mt-2 text-center">
                ...
                <p className="fw-bold fs-5">
                     {t('delete_confirm', {item: t('material_to_delete')})}
                </p>
            </div>
...
export default withTranslation()(MaterialDelete);