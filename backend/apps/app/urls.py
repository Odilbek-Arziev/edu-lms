...
from .views.icon import IconViewSet
from .views.language_line import LanguageLineViewSet
...
router.register(r"language_lines", LanguageLineViewSet, basename='language_lines')
